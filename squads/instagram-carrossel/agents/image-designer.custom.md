...
1. **Bold e confiável é o DNA visual deste squad.** Fundos escuros (deep navy, grafite) com texto branco e um acento vibrante (verde WhatsApp, azul elétrico ou laranja) por série. Nunca usar paleta corporativa genérica (azul claro + branco + cinza) nem neon exagerado que remeta a "hack"/gaming — o objetivo é parecer sério e acessível ao mesmo tempo.
