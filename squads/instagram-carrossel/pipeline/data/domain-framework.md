...
**Domain:** Conteúdo educacional em carrossel para o perfil profissional do Joao Vitor — sites e automação de WhatsApp para pequenos negócios locais
**Last Updated:** 2026-07-01 (adaptado do template original de 2026-03-03)
...
### The 5 Standard Angles for Sites & Automação (Pequenos Negócios)

| Ângulo | Emoção Primária | Hook Pattern | Ideal Para |
|--------|----------------|--------------|------------|
| Revelador | Surpresa + Curiosidade | "[Dado]% dos donos de negócio local não sabem que..." | Estatísticas de conversão, pesquisa/atendimento |
| Comparativo | FOMO + Status | "A diferença entre o negócio que tem site/automação e o que não tem" | Concorrência local, antes/depois de um cliente real |
| Pergunta Incômoda | Dissonância Cognitiva | "Por que seu negócio ainda perde cliente pra concorrência no WhatsApp?" | Crenças como "meu cliente só vem por indicação" |
| Tendência + Oportunidade | Urgência + Esperança | "Isso mudou nos últimos meses. A maioria dos comércios locais ainda não percebeu." | Mudança de comportamento do consumidor (busca no Google/Insta antes de comprar) |
| Passo a Passo | Segurança + Competência | "São [N] passos pra automatizar seu atendimento. Dá pra começar essa semana." | Tutoriais práticos (ex: como estruturar um fluxo de WhatsApp) |

### Angle Selection Criteria
- **Match to audience awareness level**: Donos de negócio que nunca pensaram em site/automação → Revelador/Passo a Passo. Donos que já cogitam mas hesitam → Comparativo/Pergunta Incômoda
- **Match to content type**: Dado de mercado/pesquisa → Revelador/Tendência. Case real de cliente → Comparativo. Metodologia de automação → Passo a Passo
- **Avoid overuse**: Não usar o mesmo ângulo em carrosséis consecutivos
- **Autoridade sem venda direta**: O carrossel educa e demonstra competência; ele não é um anúncio do serviço. O CTA pode convidar para DM/conversa, mas o corpo do conteúdo entrega valor real mesmo para quem nunca vira cliente
