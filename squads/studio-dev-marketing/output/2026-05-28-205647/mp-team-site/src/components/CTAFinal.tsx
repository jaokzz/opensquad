...
import { WA_COMECAR } from '@/lib/constants'
...
export default function CTAFinal() {
  ...
  return (
    <section ref={ref} className="py-32 lg:py-40 overflow-hidden"
      style={{ background: '#080810' }}>
      <div className="max-w-[1300px] mx-auto px-6 lg:px-12">
        <div className="cta-block opacity-0 relative rounded-3xl overflow-hidden p-12 lg:p-20 text-center"
          ...
          <div className="relative z-10">
            <span className="inline-flex items-center gap-2 text-[10px] font-bold tracking-[0.22em] uppercase px-4 py-2 rounded-full mb-8"
            ...
            <p className="mb-12 text-[16px]" style={{ color: '#7A7A8C', maxWidth: '480px', margin: '0 auto 3rem' }}>
              Sem dietas absurdas. Sem abrir mão da vida boa.
              A Pietra vai te mostrar como.
            </p>

            <a href={WA_COMECAR} target="_blank" rel="noopener noreferrer"
