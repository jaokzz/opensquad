...
const FAQS = [
  ...
  },
  {
    ...
    a: "O investimento varia de acordo com o plano escolhido. Enviamos os valores diretamente pelo WhatsApp — sem compromisso. O que posso adiantar: cabe no bolso mais do que você imagina, e entrega muito mais do que uma academia convencional.",
  },
];
...
function FAQItem({
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-semibold text-white text-[14px] md:text-[15px] leading-snug">
          {q}
        </span>
        <motion.span
