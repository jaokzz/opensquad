...
export default function Hero() {
      ...
      ctx = gsap.context(() => {
        gsap
          ...
          .fromTo(
            ...
            { clipPath: "inset(0% 0% 0% 0% round 28px)", duration: 1, ease: "power4.inOut" },
            "-=0.85"
          );
  ...
  return (
    ...
    >
      {/* Background glows */}
      <div
        className="absolute top-[-25%] right-[-8%] w-[600px] h-[600px] rounded-full pointer-events-none"
      ...
      <div className="relative z-10 w-full max-w-[1300px] mx-auto px-6 lg:px-12 pt-24 lg:pt-28 pb-16 lg:pb-20">
        <div className="grid lg:grid-cols-[1fr_440px] xl:grid-cols-[1fr_500px] gap-8 lg:gap-20 items-center">
          {/* Photo side — visible on all screens, above text on mobile */}
          <div className="order-1 lg:order-2">
            <div
              className="h-photo relative rounded-[24px] lg:rounded-[28px] overflow-hidden mx-auto"
              style={{
                clipPath: "inset(100% 0% 0% 0% round 28px)",
                aspectRatio: "4/5",
                maxWidth: "420px",
            ...
            >
              ...
              />
              <div
                className="absolute bottom-5 left-4 right-4 rounded-xl px-4 py-3"
                style={{
          ...
          <div className="order-2 lg:order-1">
            ...
            {/* Headline */}
            <div
              className="h-headline mb-4"
              style={{ transformStyle: "preserve-3d" }}
            >
              <h1
                className="font-black leading-[0.91] tracking-[-0.03em] text-white"
                style={{ fontSize: "clamp(58px, 8.5vw, 116px)" }}
              >
                {WORDS.map((word, i) => (
                  <span
                    key={i}
                    className="h-word inline-block mr-[0.18em] opacity-0"
              ...
              <div style={{ fontSize: "clamp(54px, 8vw, 110px)" }}>
                <span
                  className="h-accent italic font-black opacity-0 inline-block"
                  style={{
            ...
            {/* Subtitle */}
            <p
              className="h-sub opacity-0 leading-relaxed mb-10"
              style={{
            ...
            >
              Treino e alimentação que encaixam na sua vida — não o contrário.
              Sem extremismos, sem sofrimento. Resultado visível no espelho em
              menos de 30 dias.
            </p>
