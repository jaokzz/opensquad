...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[30rem] md:h-[42rem] flex items-center justify-center relative p-2 md:p-8"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-4 mx-auto h-[16rem] md:h-[22rem] w-full border border-zinc-800 p-1.5 md:p-3 bg-zinc-950 rounded-[24px] shadow-2xl"
    >
