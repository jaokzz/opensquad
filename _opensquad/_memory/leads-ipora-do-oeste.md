...
## 🔴 Alta Prioridade — Sem site

| Negócio | Segmento | Presença atual | Por que é candidato |
|---------|----------|----------------|---------------------|
...
| Íntegra Cursos | Escola / Cursos profissionalizantes | Facebook | Melhor escola de formação profissional local; sem site |
| PMS Soluções Contábeis | Contabilidade | Facebook | Ativo desde 2012; apenas diretórios e Facebook |
| Habilar Imobiliária | Imobiliária | Diretórios | Sem site próprio confirmado |
| Despachante Central | Despachante | Páginas Amarelas | Apenas listagem em diretórios |

---

## 🟡 Média Prioridade — Site ruim/desatualizado

| Negócio | Segmento | Situação do site | Oportunidade |
|---------|----------|-----------------|--------------|
| Canísio Muller Escritório Contábil | Contabilidade | contabilcanisio.com.br — institucional básico | Design provavelmente desatualizado; empresa desde 1983 |
| Escritório Contábil Oeste (EC Oeste) | Contabilidade | ecoeste.com.br/site — URL com "/site/" sugere instalação básica | Design possivelmente antiquado |
| Corretores Iporã | Imobiliária | corretoresipora.com.br — funcional | Pode ser simples; avaliar mobile |
| Restaurante Divina Gula | Restaurante | restaurantedivinagula.com.br — básico | Cardápio digital integrado seria upgrade |
| Wizard Iporã do Oeste | Escola de idiomas | Página dentro do site da franquia | Landing page local seria diferencial para captação |
| Real Informática | Informática | realinformatica.net.br — existe | Verificar se está atualizado e responsivo; empresa desde 1998 |
...
| Negócio | Motivo |
|---------|--------|
| OdontoTop Hospital do Dente | Franquia nacional com site profissional robusto |
| Farmácias (Farmavida, São Miguel, etc.) | Margens apertadas, baixo interesse em landing pages |
| Mercados locais (Avenida, RC, Jundiá) | Baixo potencial de ROI |
| SENAI Iporã do Oeste | Instituição pública com estrutura própria |
| Grupo Jantsch (construção) | B2B, perfil diferente |
| Agropecuária Ouro Branco | B2B rural |
| Salão de Beleza da Betiane | Muito pequeno — 95 seg Instagram, 13 avaliações Google |

---

## 🏆 Próximos a abordar (sugeridos por Lucas Leads — 2026-06-22)

1. **Clínicas médicas / odontológicas** — dentista, médico de família, psicólogo
2. **Contabilidade** — PMS Soluções Contábeis (ativo desde 2012, só Facebook)
3. **Mecânicas** — Bienert e Lorenzet (viajantes que têm problema na estrada pesquisam no Google)
4. **Íntegra Cursos** — escola profissionalizante, sem site
5. **Restaurante Althernativo / Paiol** — próximos restaurantes da lista

---

## 📝 Mensagens utilizadas (templates validados)

### Academia da Adri
> "Oi Adriane! Passei no teu perfil e fiquei impressionado — 174 avaliações com nota 5.0, e os comentários são dos mais bonitos que já vi: 'não sou apenas um número', 'encontrei uma família'. O problema é que quem ainda não te conhece não vê isso. Esse patrimônio todo fica escondido no Google Maps, enquanto a primeira impressão de muita gente ainda é um Linktree laranja. Um site organizaria tudo isso num lugar só. Posso montar um protótipo rápido pra você visualizar. Sem compromisso nenhum."

### Bem Estar Clínica
> "Oi! Sou o João, desenvolvedor web aqui de Iporã. Passei no perfil de vocês e fiquei impressionado com a qualidade do conteúdo — nível de clínica de capital mesmo. Só que quem vai investir num procedimento de harmonização ou criolipólise pesquisa bastante antes. E nessa pesquisa, clínicas de Chapecó e SMOeste que têm site aparecem primeiro. Posso montar um protótipo rápido. Sem compromisso."

### Hotel e Pousada Iporã
> "Deixa eu ser direto: se a pousada tem 10 reservas por mês vindo pelo Booking, vocês estão pagando em torno de R$ 300 a R$ 600 por mês só de comissão pra eles — todo mês, todo ano, sem parar. Um site próprio custa uma fração disso, é feito uma vez, e a partir daí quem reservar direto pelo WhatsApp não paga comissão nenhuma pra ninguém."

### Armazém Bar e Burguer
> "Oi Carol! Passei lá semana passada de novo, esse Professor não tem explicação 😂 Você sabe que eu trabalho com desenvolvimento de sites né? Tava pensando aqui, o Armazém merecia muito ter um site próprio — cardápio completo, as pizzas, tudo organizado, com um botão direto pro WhatsApp. Posso montar um protótipo rápido só pra você ver como ficaria? Sem compromisso nenhum."
